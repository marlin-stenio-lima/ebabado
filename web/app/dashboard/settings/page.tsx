            ...
            <form onSubmit={handleSaveConfig} className="space-y-4">
                <Tabs defaultValue="general" className="space-y-4">
                    <TabsList>
                        ...
                        <TabsTrigger value="contact">Contato e Local</TabsTrigger>
                    </TabsList>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-1">
                                    ...
                                    <Input
                                        id="hero_title"
                                        placeholder="Ex: Vem pro Bloquinho"
                                ...
                                <div className="space-y-1">
                                    ...
                                    <Textarea
                                        id="hero_description"
                                        placeholder="Ex: Prepare sua fantasia e vem curtir..."
                                        value={config?.hero_description || ''}
                                        onChange={(e) => setConfig({ ...config, hero_description: e.target.value })}
                                    />
                                </div>
                                <div className="space-y-1">
                                    <Label htmlFor="event_date">Data do Evento (Contagem Regressiva)</Label>
                                    <Input
                                        id="event_date"
                                        type="datetime-local"
                                        value={config?.event_date ? new Date(config.event_date).toISOString().slice(0, 16) : ''}
                    ...
                    <TabsContent value="content" className="space-y-4">
                        <Card>
                            <CardHeader>
                                <CardTitle>Atrações e Regras</CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="space-y-1">
                                    <Label htmlFor="attractions">Atrações</Label>
                                    <Textarea
                                        id="attractions"
                                        rows={4}
                                        value={config?.attractions || ''}
                                        onChange={(e) => setConfig({ ...config, attractions: e.target.value })}
                                    />
                                </div>
                                <div className="space-y-1">
                    ...
                    <TabsContent value="contact" className="space-y-4">
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-1">
                                    <Label htmlFor="whatsapp_link">Link do WhatsApp (Botão Ingressos)</Label>
                                    <Input
                                        id="whatsapp_link"
